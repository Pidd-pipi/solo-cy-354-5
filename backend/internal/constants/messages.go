...
const (
	...
	MsgHandoverCodeMismatch = "面交码错误，核销失败，请与买家核对后重新输入"
	MsgHandoverCodeExpired  = "面交码已过期，核销失败，请让买家重新生成"
	MsgHandoverCodeUsed     = "面交码已被使用，一次性码不可重复核销"
	MsgHandoverCodeNoCode   = "订单当前没有可用的面交码，请让买家先确认订单"
	MsgNotSeller            = "仅卖家可以核销面交码"
	MsgNotBuyer             = "面交码仅对买家展示"
	MsgHandoverCodeFormat   = "面交码为6位数字"
